...
CarSellorder is implemented according to description from “Custom Box Class creation” (`section <07-Sidechain-SDK-extension.html#custom-box-class-creation>`_) as
